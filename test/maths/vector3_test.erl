...
run() ->
	...
	test_facilities:display( "Base textual representation for V3D = ~w:~n~ts",
	...
	test_facilities:display( "User-friendly textual representation "
		"for V3D = ~w:~n~ts", [ V3D, vector3:to_user_string( V3D ) ] ),

	test_facilities:display( "User-friendly textual representation "
		"for VecP = ~w:~n~ts", [ VecP, vector3:to_user_string( VecP ) ] ),

	test_facilities:display( "V1 =~n~ts", [ vector3:to_string( V1 ) ] ),

	V2 = [ 1.0, 2.0, 3.0 ],
	test_facilities:display( "V2 =~n~ts", [ vector3:to_string( V2 ) ] ),
	...
	test_facilities:display( "Unit V3 = ~n~ts", [ vector3:to_string( V3 ) ] ),
