...
erlang_version="26.0.2" # "26.0"
erlang_sum="${erlang_sha512_for_26_0_2}" # "${erlang_sha512_for_26_0}"
...
#
erlang_version_candidate="26.0" # "25.3"
erlang_sum_candidate="${erlang_sha512_for_26_0}"
