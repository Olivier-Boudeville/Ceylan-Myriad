...
# Current stable (two changes just below are needed to update it):
erlang_version="22.2"
erlang_md5="${erlang_md5_for_22_2}"
...
#
erlang_version_candidate="22.1"
erlang_md5_candidate="${erlang_md5_for_22_1}"
